...
/**
 * Given a sorted array of Integers, find the target. If the target is not found, return the element
 * closest to the target. For example, A = [1,2,4,5,7,8,9], Target = 6 -> Output Index = 3 or 4
...
public class BinarySearchWithClosest {
  ...
  /** Space Complexity: O(logn) Time Complexity: O(1) */
