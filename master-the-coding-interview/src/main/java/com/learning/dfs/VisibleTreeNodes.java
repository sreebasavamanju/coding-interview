...
/**
 * 
 * In a binary tree, we define a node "visible" when no node on the
 * root-to-itself path (inclusive) has a greater value. The root is always
 * "visible" since there are no other nodes between the root and itself. Given a
 * binary tree, count the number of "visible" nodes.
 *
 */
