...
/**
 * 
 * A balanced binary tree is defined as a tree such that either it is an empty
 * tree, or all its subtree are balanced and has a height difference of at most 1.
 * 
