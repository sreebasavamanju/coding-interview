...
/**
 * Given an integer, find its square root without using the built-in square root function. Only
 ...
 * <p>Output: 2
 *
 * <p>Explanation: square root of 8 is 2.83..., return integer part 2
 */
